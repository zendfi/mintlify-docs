...
<CardGroup cols={2}>
  ...
  <Card title="Sub-Account Controls" icon="folder-tree" href="/api-reference/sub-accounts">
    Policy-driven delegation, execution intents, triggers, and balance automation.
  </Card>
</CardGroup>
