...
<ParamField body="policy_version_id" type="string">
  Optional policy version UUID attached to this token.
</ParamField>

<ParamField body="agent_label" type="string">
  Optional actor label for audit attribution.
</ParamField>

<ParamField body="agent_public_key" type="string">
  Optional actor public key for attribution.
</ParamField>

<ParamField body="agent_metadata" type="object">
